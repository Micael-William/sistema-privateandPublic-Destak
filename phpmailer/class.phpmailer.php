...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'acompanhamento@sistemadestakpublicidade.com.br';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Destak Publicidade';
   ...
   * @var string
   */
  public $Username      = 'acompanhamento@sistemadestakpublicidade.com.br';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'Publi1234$';
